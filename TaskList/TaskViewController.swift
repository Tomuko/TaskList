...
class CustomButtonFactory: ButtonFactory {
    ...
    func createButton() -> UIButton {
        ...
        var attribures = AttributeContainer()
        attribures.font = UIFont.boldSystemFont(ofSize: 18)
        
        // Set configuration for button
        var buttonConfiguration = UIButton.Configuration.filled()
        buttonConfiguration.attributedTitle = AttributedString(title, attributes: attribures)
